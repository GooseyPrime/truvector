...
export default function EmmaPage() {
  return (
    <div className="min-h-screen flex flex-col text-slate-200 p-4 md:p-8 font-sans selection:bg-emerald-500/30 relative overflow-hidden" style={{ paddingTop: '5rem', paddingBottom: '150px' }}>
